                ...
                <h1 className='fs-4 mb-2 ms-4'>Ayarlar</h1>
                  <ul className={styles.ulMenu} ref={ulList}>
                    ...
                    <NavLink  className={({ isActive }) =>
                      isActive ? `text-secondary-emphasis active ${styles.active}` : 'text-secondary-emphasis' } to="/user/profile">
                        <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-fill" viewBox="0 0 16 16">
                   ...
                   <span>Profili Düzenle</span>
                      ...
                      <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-badge-fill" viewBox="0 0 16 16">
                   ...
                   <span>Kişisel Bilgiler</span>
                      ...
                      <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-lock-fill" viewBox="0 0 16 16">
                   ...
                   <span>Gizlilik ve Güvenlik</span>
                      ...
                      <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star-fill" viewBox="0 0 16 16">
                  ...
                  <span>İlgilerim</span>
                   ...
                   <span>etkinlikdolu+ Aboneliği</span>
                      ...
                      <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-credit-card-2-back-fill" viewBox="0 0 16 16">
                  ...
                  <span>Ödeme Yöntemleri</span>
                      ...
                      <a className='text-light-emphasis' href='/help' >
                        <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-info-circle-fill" viewBox="0 0 16 16">
