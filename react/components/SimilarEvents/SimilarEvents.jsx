...
const SimilarEvents = ({ similarEventsInfo }) => {
  return (
    ...
    <div className="row d-flex flex-row gx-1">
      ...
      {similarEventsInfo.length > 0 && (
       ...
       <h1 className="fs-4 mt-5 mb-3 fw-bolder">Benzer Etkinlikler</h1>
          ...
          {similarEventsInfo.map((event) => {
            return (
            <div key={event._id} className="col-lg-3 col-md-4 col-sm-6 my-2">
              <a draggable={false} href={event._id} className="w-100  d-flex justify-content-center justify-content-lg-start align-items-center">
                ...
                <span className="text-body-secondary location-span my-2 text-capitalize">
                          <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo" viewBox="0 0 16 16">
